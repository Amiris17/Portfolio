    ...
    <>
      ...
      <body>
        ...
        <div class="paragraph ">
          <Typewriter
            onInit={(typewriter)=>{
              typewriter.typeString("Amiris Olivo, Software Engineer in New York ").pauseFor(200).start();
            }}
        ...
        <div class="paragraph_2 centered-text-block">
            A computer science graduate from Hunter College with a deep passion for programming. Since a young age, I’ve been driven to expand my knowledge and skills in this field. I thrive in collaborative environments, always aiming to support my team and make a positive impact. My goal is to continuously grow and become the best version of myself. I am passionate about both machine learning and front-end development. I’ve had the opportunity to work on exciting projects, such as the K-means clustering algorithm and the creation Add-ons for games such as World Of Warcraft.
        <p> 
          All my projects are posted on github. If you'd like to get in touch feel free to say hello through the social links. </p>
        </div>
        <div class="paragraph_3 centered-text-block">
        ...
        <li> <a target="_blank" href="https://react.dev/"> </a> <FaReact size={35}/> 
        </li>
